...
export const TYPE_LIBRARY: Record<string, TypeEntry> = {
  ...
  "FLIP": { code: "FLIP", image: "https://media.c1aile.com/4907a220-5e3f-4ba0-91d7-12444a9181e9", cn: "反复横跳侠", intro: "这个方案推翻了，我们重来。", desc: `恭喜你，你是职场不确定性大师。你的工作状态永远在推翻重来，上午定的方向下午就变，昨天确认的方案今天就改。你不是在工作，你是在进行一场名为"换个方向"的持续运动。老板已经习惯了你的一变再变，学会了等你自然稳定再验收。` },
  "ALL": { code: "ALL", image: "https://media.c1aile.com/6315c5ab-18bb-4f2d-bdfc-bafc6907f873", cn: "全能打工人", intro: "写代码？做PPT？谈客户？都我来。", desc: `恭喜你，你就是那个一个人撑起整个部门的人。别人只会一样，你会三样；别人下班了，你还在。你是公司最离不开的人，也是最廉价的人。全能打工人，你的工资配不上你的能力，你的领导看不见你的付出。` },
  "FOMO": { code: "FOMO", image: "https://media.c1aile.com/b7ec98d2-f725-4ad2-9b49-9de0ddf5bfa0", cn: "职场焦虑症", intro: "老板发消息了，是不是我又出问题了？", desc: `恭喜你，你是职场焦虑本虑。你对老板的消息过敏，你对话术变更敏感，你对会议邀请惊恐。别人上班是赚钱，你上班是渡劫。你的人生一半在睡觉，一半在想工作，真正的工作反而没干多少。焦虑症晚期，但老板觉得你工作态度有问题。` },
